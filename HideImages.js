...
// });
	...
	styleToHideCoverArtImageOnAnAlbumPage.innerHTML = `
		...
		{
			background: "https://www.shutterstock.com/image-vector/headphones-music-concept-illustration-polygon-600w-413771752.jpg" !important;
		}`;
	...
	function migrateStorage() {
		...
		function migrateKey(oldKey, newKey) {
		    ...
		    if (oldData !== null) {
			Spicetify.LocalStorage.set(newKey, oldData);
	...
	function putDataLocal() {
		...
		Spicetify.LocalStorage.set("HideImages_TrashSongList", JSON.stringify(trashSongList));
		Spicetify.LocalStorage.set("HideImages_TrashArtistList", JSON.stringify(trashArtistList));
	}
